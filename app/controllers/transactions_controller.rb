class TransactionsController < EnterprisesController
  ...
  def transaction_params
    ...
    params.require(:transaction).permit(:status, :fecha, :orden_Trabajo, :service_number, :remision, :factura, :hora_llegada,
                                        ...
                                        client_attributes: [:nombre, :tipo_identificacion, :identificacion, :razon_social, :regimen, :actividad_comercial,
                                                            :direccion, :ciudad, :telefono, :email, :enterprise_id, account_ids: []],
